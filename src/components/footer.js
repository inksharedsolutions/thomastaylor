        ...
        <>  
            <footer className="footer-section">
                <div className="container-gt" id="footer-info">
                    ...
                    Thomas Taylor, M.D. loves to hear from readers. You can reach him via email. 
                    ...
                    <nav>
                        <ul>
                            ...
                            <li>
                                <a 
                                    target="_blank"
                                    href="https://www.goodreads.com/book/show/57997971-working-with-weight?ac=1" rel="noreferrer">
                                    <FontAwesomeIcon 
                                        className='font-awesome'
                                        icon={faGoodreads} />
                                </a>
